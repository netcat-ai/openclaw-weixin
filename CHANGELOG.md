...
- **OpenClaw group activation:** Add per-group `requireMention` integration and `chatTypes: ["direct", "group"]` capability metadata without a plugin-specific sender allowlist.
